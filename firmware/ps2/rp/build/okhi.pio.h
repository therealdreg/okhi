...
#define inhibited_signal_pio_version 0

static __pio_const uint16_t inhibited_signal_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program inhibited_signal_program = {
    .instructions = inhibited_signal_program_instructions,
    .length = 11,
    .origin = -1,
    .pio_version = inhibited_signal_pio_version,
...
#define device_to_host_pio_version 0

static __pio_const uint16_t device_to_host_program_instructions[] = {
            //     .wrap_target
    0x00c0, //  0: jmp    pin, 0
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program device_to_host_program = {
    .instructions = device_to_host_program_instructions,
    .length = 15,
    .origin = -1,
    .pio_version = device_to_host_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define host_to_device_pio_version 0

static __pio_const uint16_t host_to_device_program_instructions[] = {
            //     .wrap_target
    0xa0c3, //  0: mov    isr, null
    0xe025, //  1: set    x, 5
    0x00c1, //  2: jmp    pin, 1
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program host_to_device_program = {
    .instructions = host_to_device_program_instructions,
    .length = 16,
    .origin = -1,
    .pio_version = host_to_device_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define idle_signal_pio_version 0

static __pio_const uint16_t idle_signal_program_instructions[] = {
            //     .wrap_target
    0xe03e, //  0: set    x, 30
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program idle_signal_program = {
    .instructions = idle_signal_program_instructions,
    .length = 7,
    .origin = -1,
    .pio_version = idle_signal_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define two_pin_mirror_reverse_inverter_pio_version 0

static __pio_const uint16_t two_pin_mirror_reverse_inverter_program_instructions[] = {
            //     .wrap_target
    0x4002, //  0: in     pins, 2
    0xa056, //  1: mov    y, ::isr
    0xa00a, //  2: mov    pins, ~y
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program two_pin_mirror_reverse_inverter_program = {
    .instructions = two_pin_mirror_reverse_inverter_program_instructions,
    .length = 3,
    .origin = -1,
    .pio_version = two_pin_mirror_reverse_inverter_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define two_pin_inverter_pio_version 0

static __pio_const uint16_t two_pin_inverter_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program two_pin_inverter_program = {
    .instructions = two_pin_inverter_program_instructions,
    .length = 1,
    .origin = -1,
    .pio_version = two_pin_inverter_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define two_pin_mirror_pio_version 0

static __pio_const uint16_t two_pin_mirror_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program two_pin_mirror_program = {
    .instructions = two_pin_mirror_program_instructions,
    .length = 1,
    .origin = -1,
    .pio_version = two_pin_mirror_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define two_pin_reverse_pio_version 0

static __pio_const uint16_t two_pin_reverse_program_instructions[] = {
            //     .wrap_target
    0x4002, //  0: in     pins, 2
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program two_pin_reverse_program = {
    .instructions = two_pin_reverse_program_instructions,
    .length = 2,
    .origin = -1,
    .pio_version = two_pin_reverse_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define glitch_det_fast_rise_pio_version 0

static __pio_const uint16_t glitch_det_fast_rise_program_instructions[] = {
            //     .wrap_target
    0xe03f, //  0: set    x, 31
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program glitch_det_fast_rise_program = {
    .instructions = glitch_det_fast_rise_program_instructions,
    .length = 7,
    .origin = -1,
    .pio_version = glitch_det_fast_rise_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define glitch_det_fast_fall_pio_version 0

static __pio_const uint16_t glitch_det_fast_fall_program_instructions[] = {
            //     .wrap_target
    0xe03f, //  0: set    x, 31
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program glitch_det_fast_fall_program = {
    .instructions = glitch_det_fast_fall_program_instructions,
    .length = 7,
    .origin = -1,
    .pio_version = glitch_det_fast_fall_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define rise_counter_pio_version 0

static __pio_const uint16_t rise_counter_program_instructions[] = {
            //     .wrap_target
    0xa02b, //  0: mov    x, ~null
    0x20a0, //  1: wait   1 pin, 0
    0x2020, //  2: wait   0 pin, 0
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program rise_counter_program = {
    .instructions = rise_counter_program_instructions,
    .length = 6,
    .origin = -1,
    .pio_version = rise_counter_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define fall_counter_pio_version 0

static __pio_const uint16_t fall_counter_program_instructions[] = {
            //     .wrap_target
    0xa02b, //  0: mov    x, ~null
    0x2020, //  1: wait   0 pin, 0
    0x20a0, //  2: wait   1 pin, 0
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program fall_counter_program = {
    .instructions = fall_counter_program_instructions,
    .length = 7,
    .origin = -1,
    .pio_version = fall_counter_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
