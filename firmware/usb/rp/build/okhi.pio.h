...
#define tar_lowsp_pio0_pio_version 0

static __pio_const uint16_t tar_lowsp_pio0_program_instructions[] = {
            //     .wrap_target
    0xa02b, //  0: mov    x, ~null
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program tar_lowsp_pio0_program = {
    .instructions = tar_lowsp_pio0_program_instructions,
    .length = 32,
    .origin = -1,
    .pio_version = tar_lowsp_pio0_pio_version,
...
static __pio_const uint16_t tar_pio1_program_instructions[] = {
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program tar_pio1_program = {
