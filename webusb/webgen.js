...
const EXTRA_PATH_GZ_EMBED = path.join('..', 'firmware', 'usb', 'esp', 'main', 'index.html.gz');
const EXTRA_MIN = path.join('..', 'firmware', 'usb', 'esp', 'src', 'webuff.txt');
const EXTRA_GZ  = path.join('..', 'firmware', 'usb', 'esp', 'src', 'webuff_gz.txt');
const EXTRA_ORI = path.join('..', 'firmware', 'usb', 'esp', 'src', 'webuff_orig.txt');
